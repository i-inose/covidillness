...
#前処理1
df = pd.read_csv("https://covid19.mhlw.go.jp/public/opendata/severe_cases_daily.csv")
index = pd.date_range("2020-05-09", "2022-06-22", freq = "D")
...
#前処理２
df1 = pd.read_csv("https://covid19.mhlw.go.jp/public/opendata/number_of_deaths_daily.csv")
index1 = pd.date_range("2020-05-09", "2022-06-2", freq = "D")
